...
async function main() {
    ...
    let launchPadContract = await launchPadFactory.deploy(tokenAddress, busdAddress, rirAddress, utils.parseEther("0.01"),utils.parseEther("1000000"),utils.parseEther("1636621670"),utils.parseEther("1639213661"),utils.parseEther("100"),utils.parseEther("500"), true);
    ...
    const launchPadAddress = launchPadContract.address;
     ...
     console.log("LaunchPad Contract param",tokenAddress, busdAddress, rirAddress, utils.parseEther("0.01"),utils.parseEther("1000000"),utils.parseEther("1636621670"),utils.parseEther("1639213661"),utils.parseEther("100"),utils.parseEther("500"), true)
